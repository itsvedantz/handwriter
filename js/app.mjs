 ...
 *
 * If you have any questions related to code, you can drop them in my Twitter DM @vedantcodes
 * or in my email at vedant99@gmail.com
 *
...
fetch('https://api.github.com/repos/vedant/text-to-handwriting/contributors')
  .then((res) => res.json())
  .then((res) => {
    ...
    document.querySelector('#github-contributors').innerHTML = contributors;
  })
  .catch((error) => {
